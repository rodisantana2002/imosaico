package com.app.helpers.formatacao;

/**
 * Esta classe contém métodos para efetuar conversão de datas entre os formatos ISO (yyyy-MM-dd) e ABNT (dd/MM/yyyy). Estes métodos são voltados pra agilizar a gravação e recuperação de datas em
 * Bancos de Dados MySQL.
 */
import com.app.helpers.types.clsConstants;
...
public class clsTrataDatas {
    ...
    public boolean isDateMaior(String strDataInicio, String strDataFim) {
        ...
        catch (ParseException exNFE) {
            System.out.println("formato da data invalida" + " - " + strDataInicio + " - " + strDataFim);
        }
        return false;
    }
